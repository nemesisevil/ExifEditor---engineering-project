...
public class GUI {
	...
	public void Run() {
		...
		try // kontrola bledow
		{
			...
			frame = new JFrame("Exifowy Edytor"); // nowy obiekt JFrame ktory bedzie zawierac reszte rzeczy, deklaracja z nazwa
			...
			JButton wczytaj = new JButton("Wczytaj zdjecie !"); // Tworzenie nowego obiektu(przycisku) odrazu z napisem

			JButton zapisz = new JButton("Zapisz zdjecie !"); // Tworzenie nowego obiektu(przycisku) odrazu z napisem
